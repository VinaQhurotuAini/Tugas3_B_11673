...
st.markdown("<h1 style='text-align: center; color: #4CAF50;'>Prediksi IPK - 1673</h1>", unsafe_allow_html=True)
...
if uploaded_file is not None:
    ...
    model_directory = r'C:\Users\vina qhurotu aini\Downloads\Supervised Learning (Praktek)\Model Suprevised Learning (Praktek)\Tugas3_B_11673'
